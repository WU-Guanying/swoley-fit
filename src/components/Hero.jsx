...
export default function Hero() {
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[600px] w-full mx-auto p-4'>

        <div className='flex flex-col gap-4'>
            <p>IT'S TIME TO GET</p>
            <p className="text-sm text-slate-700">GUANYING</p>
            <h1 className='uppercase font-bold font-semibold text-5xl sm:text-5xl md:text-6xl lg:text-8xl'> Swole<span className='text-blue-400'>normous</span></h1>
        </div>
